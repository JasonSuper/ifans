...
public class TestParallel {
    ...
    public void create() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("bpmn/Qj-Parallel.bpmn20.xml")
                .addClasspathResource("bpmn/Qj-Parallel.png")
                .name("请假流程-parallel")
                .deploy();
    ...
    public void startProcessAndSerGlobalVariable() {
        ...
        // 启动一个请假流程实例
        ProcessInstance instance = runtimeService.startProcessInstanceByKey("QjParallel", variables);
    ...
    public void completTask() {
        ...
        Task task = taskService.createTaskQuery()
                .processDefinitionKey("QjParallel")
                .taskAssignee("1")
                .singleResult();
    ...
    public void deleteDeployment() {
        ...
        repositoryService.deleteDeployment("4f23a45d-8117-11ed-8fae-001a7dda7111", true);
    }
