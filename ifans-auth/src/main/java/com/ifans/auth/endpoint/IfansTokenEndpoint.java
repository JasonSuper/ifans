...
package com.ifans.auth.endpoint;
...
import com.ifans.api.system.domain.TokenVo;
...
import com.ifans.common.core.util.SpringContextHolder;
import com.ifans.common.security.annotation.Inner;
import com.ifans.common.security.util.OAuth2EndpointUtils;
import com.ifans.common.security.util.OAuth2ErrorCodesExpand;
import com.ifans.common.security.util.OAuthClientException;
...
public class IfansTokenEndpoint {

    private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

    private final AuthenticationFailureHandler authenticationFailureHandler = new IfansAuthenticationFailureEventHandler();

    private final OAuth2AuthorizationService authorizationService;

    private final FeignClientDetailsService clientDetailsService;
