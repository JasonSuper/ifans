package com.ifans.auth.handler;
 ...
 */
@Slf4j
public class IfansAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        if (MapUtil.isNotEmpty(map)) {
            // 发送异步日志事件
            IfansUser userInfo = (IfansUser) map.get(SecurityConstants.DETAILS_USER);
