...
import com.ifans.common.core.util.WebUtils;
...
public class IfansDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public IfansDaoAuthenticationProvider() {
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
        ...
        Map<String, IfansUserDetailsService> userDetailsServiceMap = SpringUtil.getBeansOfType(IfansUserDetailsService.class);
