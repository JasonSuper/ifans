 ...
 * @date 2020/6/9
 */
public final class IfansSentinelFeign {

	private IfansSentinelFeign() {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new IfansSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new IfansSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new IfansSentinelInvocationHandler(target, dispatch);
				}
