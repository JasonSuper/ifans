...
package com.ifans.common.feign.sentinel.ext;
 ...
 */
@Slf4j
public class IfansSentinelInvocationHandler implements InvocationHandler {
    ...
    IfansSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            IfansSentinelInvocationHandler other = (IfansSentinelInvocationHandler) obj;
