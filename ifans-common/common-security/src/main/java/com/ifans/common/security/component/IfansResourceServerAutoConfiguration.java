...
public class IfansResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public IfansBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new IfansBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new IfansCustomOpaqueTokenIntrospector(authorizationService);
	}
