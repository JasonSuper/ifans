...
public class IfansRemoteRegisteredClientRepository implements RegisteredClientRepository {
    ...
    private final FeignClientDetailsService feignClientDetailsService;
    ...
    public RegisteredClient findByClientId(String clientId) {
        ...
        SysOauthClientDetails clientDetails = RetOps.of(feignClientDetailsService.getClientDetailsById(clientId)).getData()
