...
import com.ifans.system.domain.vo.MetaVo;
import com.ifans.system.domain.vo.RouterVo;
import com.ifans.system.domain.vo.TreeSelect;
import com.ifans.system.mapper.SysMenuMapper;
import com.ifans.system.mapper.SysRoleMapper;
import com.ifans.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements ISysMenuService {
    ...
    @Override
    public Set<String> selectMenuPermsByRoleId(Long id) {
        List<String> perms = menuMapper.selectMenuPermsByRoleId(id);
    ...
    public Set<String> selectMenuPermsByUserId(String id) {
        List<String> perms = menuMapper.selectMenuPermsByUserId(id);
        Set<String> permsSet = new HashSet<>();
        for (String perm : perms) {
            if (StrUtil.isNotEmpty(perm)) {
                permsSet.addAll(Arrays.asList(perm.trim().split(",")));
