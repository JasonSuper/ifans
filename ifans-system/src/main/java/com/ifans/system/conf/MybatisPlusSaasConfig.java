package com.ifans.system.conf;

import com.baomidou.mybatisplus.extension.plugins.MybatisPlusInterceptor;
import com.baomidou.mybatisplus.extension.plugins.handler.TenantLineHandler;
import com.baomidou.mybatisplus.extension.plugins.inner.PaginationInnerInterceptor;
import com.baomidou.mybatisplus.extension.plugins.inner.TenantLineInnerInterceptor;
import com.ifans.common.context.TenantContext;
import com.ifans.common.utils.oConvertUtils;
...
//        tenantTable.add("sys_depart");
    ...
    /*private DynamicTableNameInnerInterceptor dynamicTableNameInnerInterceptor() {
        ...
        dynamicTableNameInnerInterceptor.setTableNameHandler((sql, tableName) -> {
            ...
            if (StringUtils.isNotEmpty(dynamicTableName) && dynamicTableName.equals(tableName)) {
                // 获取前端传递的版本号标识
                Object version = ThreadLocalDataHelper.get(CommonConstant.VERSION);
                if (version != null && StringUtils.isNotEmpty(version.toString())) {
